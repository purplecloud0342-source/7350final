    ...
    try {
      if (selectedModel === 'gemini') {
        ...
        if (usage) {
          ...
          // Fallback simulation if usage is missing
          const tokens = Math.ceil(apiText.length / 3 + generatedText.length / 3);
          setApiTokenResult({ total: tokens, prompt: tokens, candidates: 0 });
        }
      }
          ...
          <div className="space-y-64">
            ...
            <div className="space-y-20">
              ...
              <div className="flex justify-center">
                ...
                >
                  <span>{expandedSubsections['4.3'] ? t('section_human.bias_details_btn_hide') : t('section_human.bias_details_btn_show')}</span>
                ...
                <AnimatePresence>
                  {expandedSubsections['4.3'] && (
                    <motion.div 
                      ...
                      className="overflow-hidden"
                    >
                      <div className="p-10 bg-white rounded-[40px] border border-forest/5 text-lg leading-relaxed text-forest/70 font-medium font-serif italic text-center shadow-inner">
