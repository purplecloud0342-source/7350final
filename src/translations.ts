export const TRANSLATIONS = {
  zh: {
    ...
    section_human: {
      ...
      bias_details_btn_show: "分析偏见循环",
      bias_details_btn_hide: "收起详情",
  ...
  en: {
    ...
    section_human: {
      ...
      industry_chain_title: " The Global Industry Chain",
      ...
      moderator_title: " Staring into the Abyss for AI",
      ...
      bias_details_btn_show: "Analyze Bias Cycle",
      bias_details_btn_hide: "Hide Details",
    ...
    section_myths: {
      ...
      subtitle: "Deconstructing AI misconceptions",
